...
import { TransactionFlowSearch } from '../../../../../../components/WorkPlatForm/MainPage/Customer/CustomerAggregated';

class CustomerAggregatedTransactionFlowSearch extends React.Component {
      getParams = (str) => {
      ...
      render() {
        ...
        return (
          <TransactionFlowSearch type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
...
}))(CustomerAggregatedTransactionFlowSearch);
