...
// 交易流水查询
class NewTransactionFlowSearch extends React.Component {
  getParams = (str) => {
  ...
  render() {
    ...
    return (
      <NewTransactionFlowSearchComponent isSkip={queryParams !== 'workplateform'} type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
    );
  }
}
