...
import { TransactionFlowStatistics } from '../../../../../../components/WorkPlatForm/MainPage/Customer/CustomerAggregated';

class CustomerAggregatedTransactionFlowStatistics extends React.Component {
      getParams = (str) => {
      ...
      render() {
        ...
        return (
          <TransactionFlowStatistics type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
...
}))(CustomerAggregatedTransactionFlowStatistics);
