...
// 交易流水统计
class NewTransactionFlowStatistics extends React.Component {
      getParams = (str) => {
      ...
      render() {
        ...
        return (
          <NewTransactionFlowStatisticsComponent isSkip={queryParams !== 'workplateform'} type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
