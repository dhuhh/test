...
import { PositionStatistics } from '../../../../../../components/WorkPlatForm/MainPage/Customer/CustomerAggregated';

class CustomerAggregatedPositionStatistics extends React.Component {
      getParams = (str) => {
      ...
      render() {
        ...
        return (
          <PositionStatistics type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
...
}))(CustomerAggregatedPositionStatistics);
