...
class NewPositionStatistics extends React.Component {
      getParams = (str) => {
      ...
      render() {
        ...
        return (
          <NewPositionStatisticsComponent isSkip={queryParams !== 'workplateform'} type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
