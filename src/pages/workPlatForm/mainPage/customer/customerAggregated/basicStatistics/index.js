...
class CustomerAggregatedBasicStatistics extends React.Component {
      getParams = (str) => {
      ...
      render() {
        const { userBusinessRole, dispatch, dictionary, authorities, match: { params: { queryParams = '' } } } = this.props;
        let tempType = '';
        let tempParams = {};
        if (queryParams !== '') {
        ...
        return (
          <NewBasicStatistics isSkip={queryParams !== 'workplateform'} userBusinessRole={userBusinessRole} type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
...
}))(CustomerAggregatedBasicStatistics);
