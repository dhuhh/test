...
class NewCapitalFlowStatistics extends React.Component {
      getParams = (str) => {
      ...
      render() {
        ...
        return (
          <NewCapitalFlowStatisticsComponent isSkip={queryParams !== 'workplateform'} type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
