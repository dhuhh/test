...
import { PositionSearch } from '../../../../../../components/WorkPlatForm/MainPage/Customer/CustomerAggregated';
...
class CustomerAggregatedPositionSearch extends React.Component {
      ...
      render() {
        ...
        return (
          <PositionSearch type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
