...
class NewCapitalflowSearch extends React.Component {
      getParams = (str) => {
      ...
      render() {
        ...
        return (
          <NewCapitalFlowSearchComponent isSkip={queryParams !== 'workplateform'} type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
