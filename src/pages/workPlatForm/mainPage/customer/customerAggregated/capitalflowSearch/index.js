...
import { CapitalFlowSearch } from '../../../../../../components/WorkPlatForm/MainPage/Customer/CustomerAggregated';

class CustomerAggregatedPositionSearch extends React.Component {
      getParams = (str) => {
      ...
      render() {
        ...
        return (
          <CapitalFlowSearch type={tempType} dispatch={dispatch} params={tempParams} dictionary={dictionary} authorities={authorities} />
        );
      }
}
...
}))(CustomerAggregatedPositionSearch);
