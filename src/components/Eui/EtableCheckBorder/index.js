...
export default class eTableCheckBorder extends React.Component {
  state = {
    checkboxCache: {
      selectAll: false,
      selectedRowKeys: [],
  ...
  render() {
    const { rowSelection, rowKey = "id", columns, dataSource ,options = {} } = this.props;
    const finalColumns = [];
    ...
    return (
      <Table
        className={styles.eTableCheckBorder}
        rowKey={rowKey}
