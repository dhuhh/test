...
class TableBtn extends Component {
  ...
  exportApi = (type)=>{
    switch(type){
      case 1: return getNoticeDataResponseExport;

      default:getNoticeDataResponseExport;
    }
  }
  // 生成uuid
  guid = () => {
  ...
  render() {
    ...
    return (
      <>
      <Divider style={{ margin: '24px 0 24px 0' }}></Divider>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'baseline'}}>
        <div style={{display:'flex',alignItems:'center'}}>
          <span style={{ height: 15, width: 4, background: '#244FFF', display: "inline-block", marginRight: 4,borderRadius:'1px' }}></span>
