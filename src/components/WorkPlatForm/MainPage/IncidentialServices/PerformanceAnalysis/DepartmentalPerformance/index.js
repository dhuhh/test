...
import { FetchDepPerfermReport } from '../../../../../../services/incidentialServices';
import DataTable from './DataTable';
import SearchContent from './SearchContent';

class DepartmentalPerformance extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default DepartmentalPerformance;