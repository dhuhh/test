  ...
  function(a, b) {
    var c = {},
      ...
      f = d.Base = {
        ...
        clone: function() {
          return this.init.prototype.extends(this)
        }
      },
      g = d.WordArray = f.extends({
        init: function(a, c) {
      ...
      l = d.BufferedBlockAlgorithm = f.extends({
        reset: function() {
    ...
    d.Hasher = l.extends({
      cfg: f.extends(),
      init: function(a) {
        this.cfg = this.cfg.extends(a), this.reset()
      },
      reset: function() {
...
function(b) {
  var c = a,
    ...
    j = d.Cipher = g.extends({
      ...
      init: function(a, b, c) {
        this.cfg = this.cfg.extends(c), this._xformMode = a, this._key = b, this.reset()
      },
      reset: function() {
  ...
  var n = d.CipherParams = e.extends({
      init: function(a) {
        this.mixIn(a)
      },
      toString: function(a) {
    ...
    o = d.SerializableCipher = e.extends({
      cfg: e.extends({
        format: k
      }),
      encrypt: function(a, b, c, d) {
        d = this.cfg.extends(d);
      ...
      decrypt: function(a, b, c, d) {
        return d = this.cfg.extends(d), b = this._parse(b, d.format), a.createDecryptor(c, d).finalize(b.ciphertext)
      },
      _parse: function(a, b) {
    ...
    p = d.PasswordBasedCipher = o.extends({
      cfg: o.cfg.extends({
        kdf: c
      }),
      encrypt: function(a, b, c, d) {
        return d = this.cfg.extends(d), c = d.kdf.execute(c, a.keySize, a.ivSize), d.iv = c.iv, a = o.encrypt.call(this, a, b, c.key, d), a.mixIn(c), a
      },
      decrypt: function(a, b, c, d) {
        return d = this.cfg.extends(d), b = this._parse(b, d.format), c = d.kdf.execute(c, a.keySize, a.ivSize, b.salt), d.iv = c.iv, o.decrypt.call(this, a, b, c.key, d)
      }
    })
}(), function() {
