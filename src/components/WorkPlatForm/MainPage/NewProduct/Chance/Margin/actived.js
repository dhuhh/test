...
import { MarginFinance } from '$services/newProduct';
...
export default class actived extends Component {
  ...
  fetchData = ()=>{
    ...
    render() {
      ...
      const btnProps = { type: 1,total,getColumns: this.getColumns,param: this.getParam(),selectAll: this.state.selectAll,selectedRows: this.state.selectedRows,md5: this.state.md5 };
      return (
        <div
