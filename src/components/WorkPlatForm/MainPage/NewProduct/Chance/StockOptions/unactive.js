...
import { StockOptions } from '$services/newProduct';
...
export default class unactive extends Component {
  ...
  render() {
    ...
    const btnProps = { type: 2,total,getColumns: this.getColumns,param: this.getParam(),selectAll: this.state.selectAll,selectedRows: this.state.selectedRows,md5: this.state.md5 };
    return (
