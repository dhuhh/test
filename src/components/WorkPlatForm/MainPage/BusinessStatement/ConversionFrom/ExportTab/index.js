...
const { ftq } = config;
const { businessStatement: { exportDataCustConver } } = ftq;
class ExportTab extends Component {
  ...
  showConfirm = () => {
    ...
    Modal.confirm({
      ...
      onOk () {
        let action = '';
        action = exportDataCustConver;
        const {  headerName = [] ,tableHeaderCodes: tableHeaderCode,payload: custConverListModel = {}  } = _props;
        custConverListModel.pageSize = 100000;
