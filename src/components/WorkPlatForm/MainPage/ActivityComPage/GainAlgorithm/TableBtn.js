...
import { Modal, message ,Progress, Row,Col, Radio } from 'antd';
    ...
    return (
      <div className={styles.title}>
        <div className={styles.label}>
          <span style={{ height: 15, width: 4, background: '#0E8AFF', display: "inline-block", marginRight: 4 , borderRadius: 1 }}></span>
