...
class ExportTab extends Component {
  ...
  render () {
    ...
    return (
      <Row style={{ color: '#61698C', paddingBottom: '16px', fontSize: '16px' }} type='flex' align='middle'>
        <Col span={24}>
          <Button onClick={this.showConfirm} className="m-btn-radius m-btn-blue" style={{ fontSize: 16,float: 'right', marginRight: '0',height: '42px',minWidth: '80px',borderRadius: 2 }} >导出</Button>
