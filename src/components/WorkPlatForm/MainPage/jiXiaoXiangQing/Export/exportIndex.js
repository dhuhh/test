...
const { ftq } = config;
const {
  newProduct: {  queryIndexCustDetailsExport }
} = ftq;
...
class TableBtn extends Component {
  ...
  exportApi = type => queryIndexCustDetailsExport;
  // 生成uuid
  guid = () => {
    const S4 = () =>
