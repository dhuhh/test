...
const CreditAccounts: FC<Props> = (props) => {
  ...
  const fetchData = () => {
    if(allParams.length > 0) {
      ...
      const params: { [key: string]: any } = {
        ...
        accountType: 3, // 1｜合并账户；2｜普通账户；3｜信用账户
        paging: 1,
        ...
        <SearchContent getAllParams={getAllParams} queryData={queryData} controlList={controlList} />
        {
          ...
          <>
            ...
            <Modal
              ...
              footer={null}
            >
              <TradingFlow type={2} cusNo={cusNo} queryValue={props.userBasicInfo.ryid} startDate={fetchParams?.startMonth} endDate={fetchParams?.endMonth} custBelong={fetchParams?.custBelong} />
            </Modal>
            <Modal
              title='客户持仓'
              ...
              footer={null}
            >
              <CustomerPosition type={2} cusNo={cusNo} tabList={'股票'} />
            </Modal>
          </>
          )
        }
