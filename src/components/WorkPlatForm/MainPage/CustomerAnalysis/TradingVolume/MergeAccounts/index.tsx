...
import { FetchQueryTradingMergeAccount } from '$services/customeranalysis';
...
const MergeAccounts: FC<Props> = (props) => {
  ...
  const fetchData = () => {
    if(allParams.length > 0) {
      ...
      FetchQueryTradingMergeAccount(params).then((response: any) => {
  ...
  const btnProps = { type: 1, iskhh: true, total: pagination.total, getColumns: getColumns, param: fetchParams, selectAll: selection.selectAll, selectedRows: selection.selectedRows, md5: md5 };
