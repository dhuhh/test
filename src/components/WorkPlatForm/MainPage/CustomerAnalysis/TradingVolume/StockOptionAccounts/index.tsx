...
import { FetchQueryTradingOptionsAccount } from '$services/customeranalysis';
...
const StockOptionAccounts: FC<Props> = (props) => {
  ...
  const fetchData = () => {
    if(allParams.length > 0) {
      ...
      const params: { [key: string]: any } = {
        ...
        custLeve: getTypeValue('investorLevel'), // 投资者级别
      ...
      FetchQueryTradingOptionsAccount(params).then((response: any) => {
  ...
  const getColumns = () => {
    return [
      ...
      },
      {
        ...
        dataIndex: 'buyToOpen',
        key: '买入开仓',
        sorter: (a: any, b: any) => a.buyToOpen - b.buyToOpen,
      },
      {
        title: '卖出开仓',
        dataIndex: 'sellToOpen',
        key: '卖出开仓',
        sorter: (a: any, b: any) => a.sellToOpen - b.sellToOpen,
      },
      {
        title: '卖出平仓',
        dataIndex: 'sellToClose',
        key: '卖出平仓',
        sorter: (a: any, b: any) => a.sellToClose - b.sellToClose,
      },
      {
        title: '买入平仓',
        dataIndex: 'buyToClose',
        key: '买入平仓',
        sorter: (a: any, b: any) => a.buyToClose - b.buyToClose,
      },
      {
        title: '备兑开仓',
        dataIndex: 'openPosition',
        key: '备兑开仓',
        sorter: (a: any, b: any) => a.openPosition - b.openPosition,
      },
      {
        title: '备兑平仓',
        dataIndex: 'closePosition',
        key: '备兑平仓',
        sorter: (a: any, b: any) => a.closePosition - b.closePosition,
      },
      {
        title: '净佣金(元)',
  ...
  const btnProps = { type: 8, iskhh: true, total: pagination.total, getColumns: getColumns, param: fetchParams, selectAll: selection.selectAll, selectedRows: selection.selectedRows, md5: md5 };
        ...
        <SearchContent getAllParams={getAllParams} queryData={queryData} controlList={controlList} />
        {
          ...
          <>
            ...
            <Modal
              ...
              footer={null}
            >
              <TradingFlow type={5} cusNo={cusNo} queryValue={props.userBasicInfo.ryid} startDate={fetchParams?.startMonth} endDate={fetchParams?.endMonth} custBelong={fetchParams?.custBelong} />
            </Modal>
            <Modal
              title='客户持仓'
              ...
              footer={null}
            >
              <CustomerPosition type={5} cusNo={cusNo} tabList={'股票,开放式基金'} />
            </Modal>
          </>
          )
        }
