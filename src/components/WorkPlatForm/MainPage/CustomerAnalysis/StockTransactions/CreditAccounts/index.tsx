  ...
  const fetchData = () => {
    if(allParams.length > 0) {
      ...
      const params: { [key: string]: any } = {
        ...
        type: 2, // 账户类型 0｜合并账户；1｜普通账户；2｜信用账户
        paging: 1,
        ...
        <SearchContent getAllParams={getAllParams} queryData={queryData} controlList={controlList} hasDateDefault={true} />
        {
          ...
          <>
            ...
            <Modal
              ...
              footer={null}
            >
              <TradingCustomer type={2} yrid={props.userBasicInfo.ryid} belong={fetchParams?.belong} stockCode={stockCode} startDate={fetchParams?.startDate} endDate={fetchParams?.endDate} />
            </Modal>
            <Modal
              title='交易流水'
              ...
              footer={null}
            >
              <TradingFlow type={2} stockCode={stockCode} queryValue={props.userBasicInfo.ryid} startDate={fetchParams?.startDate} endDate={fetchParams?.endDate} custBelong={fetchParams?.belong} />
            </Modal>
          </>
          )
        }
