...
class DGroupShare extends React.Component {
  ...
  filterOption = (inputValue, option) => option.ryxm.indexOf(inputValue) > -1 || option.rybh.indexOf(inputValue) > -1;
  ...
  render() {
    ...
    const { gxyyb, dataSource, targetTranKeys, searchValue } = this.state;
