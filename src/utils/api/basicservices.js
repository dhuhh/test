export default [
  ...
  { code: '508611', key: 'queryShortMessageChannel', url: '/basicservices/v1/queryShortMessageChannel', dis: '消息中心  获取短信通道' },
  ...
  { code: '508611', key: 'rmndEventConf', url: '/basicservices/v1/rmndEventConf', dis: '消息提醒-消息列表表头数据' },
  // HT整合 ------------------------------------------------------------------------------------------------------------------------
  { code: '', key: 'todoCenterList', url: '/taskcenter/v1/todoCenterList', dis: '获取待办数据详细列表' },
  { code: '', key: 'todoCenterClassList', url: '/taskcenter/v1/todoCenterClassList', dis: '获取待办分类数据' },
  { code: '', key: 'completedEventClass', url: '/taskcenter/v1/completedEventClass', dis: '获取已办分类数据' },
  { code: '', key: 'completedEventList', url: '/taskcenter/v1/completedEventList', dis: '获取已办分类数据详细列表' },
  ...
  { code: '', key: 'rmndEventList', url: '/taskcenter/v1/rmndEventList', dis: '消息提醒-提醒事件列表' },
  { code: '', key: 'readRmndEvent', url: '/taskcenter/v1/readRmndEvent', dis: '消息提醒-提醒事件标记已读' },
  { code: '', key: 'rmndEventNum', url: '/taskcenter/v1/rmndEventNum', dis: '任务/计划/其他-消息数' },
  ...
  { code: '508608', key: 'cusMsgBlackList', url: '/basicservices/v1/cusMsgBlackList', dis: '短信黑名单' },
  { code: '508609', key: 'cusMsgBlackListOperate', url: '/basicservices/v1/cusMsgBlackListOperate', dis: '消息黑名单客户登记' },
  { code: '', key: 'cusMsgBlackListExport', url: '/basicservices/v1/cusMsgBlackListExport', dis: '短信黑名单导出' },
  { code: '508701', key: 'sysLoginTrends', url: '/basicservices/v1/sysLoginTrends', dis: '登录情况统计趋势' },
  { code: '', key: 'sysLoginTrendsExport', url: '/basicservices/v1/sysLoginTrendsExport', dis: '登录情况统计趋势导出' },
  // 获取附件信息
  { code: '', key: 'getAttInfo', url: '/basicservices/v1/getAttInfo', dis: '获取附件信息' },
  { code: '', key: 'serverRecordCheck', url: '/basicservices/v1/serverRecordCheck', dis: '服务记录校验' },
  { code: '', key: 'serverRecordImportSure', url: '/basicservices/v1/serverRecordImportSure', dis: '服务记录导入确认' },
  { code: '', key: 'messageSndStandardDtl', url: '/basicservices/v1/messageSndStandardDtl', dis: '获取各个场景人员各渠道发送明细' },
  { code: '', key: 'messageSndStandardNum', url: '/basicservices/v1/messageSndStandardNum', dis: '获取各个场景各个人员各渠道有效数' },
];
